...
public class Encap_Animation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        class_encap = (ImageView)findViewById(R.id.class_encap);

        //TextView
        objEncap_text = (TextView)findViewById(R.id.object_encap_text);
        classEncap_text = (TextView)findViewById(R.id.classEncap_text);
        ...
        //Linearlayout
        output_layout = (LinearLayout)findViewById(R.id.output_layout);
    ...
    private void GoLine15_1()
    {
        ...
        line15_1.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                Log.d("State","line15_1 finished");
                Toast.makeText(Encap_Animation.this, "Finished", Toast.LENGTH_SHORT).show();
